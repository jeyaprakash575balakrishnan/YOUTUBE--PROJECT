...
api_key="AIzaSyAPa9JaU1sKnXdgIh76p3Eh2yyhW9xuftE "
api_service_name = "youtube"
api_version = "v3"
DEVELOPER_KEY =" AIzaSyAPa9JaU1sKnXdgIh76p3Eh2yyhW9xuftE"
youtube = googleapiclient.discovery.build(api_service_name, api_version, developerKey = DEVELOPER_KEY)


# Bridging a connection with MongoDB-existing database(project)

client = pymongo.MongoClient('mongodb+srv://jeyaprakash575:Jeya123@cluster0.bib1srk.mongodb.net/?retryWrites=true&w=majority')  
mydb = client["project"]
information = mydb.youtube

# Pushing data from mongodb to python

mongo_client = MongoClient('mongodb+srv://jeyaprakash575:Jeya123@cluster0.bib1srk.mongodb.net/?retryWrites=true&w=majority')
...
myconnection = pymysql.connect(host = '127.0.0.1',user='root',passwd='Jeya@123')
cur = myconnection.cursor()
myconnection = pymysql.connect(host = '127.0.0.1',user='root',passwd='Jeya@123',database = "youtube")
cur = myconnection.cursor()
